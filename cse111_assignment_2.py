...
Original file is located at
    https://colab.research.google.com/drive/1gfpNT_9Xn8KyzCXBc5iZYWP2dZZA3Ey6
"""
...
#7
class DemonSlayer:
  def __init__(self,name,power,technique,kills):
    self.name=name
    self.style=power
...
class buttons():
  def __init__(self,word,spaces,border):
    ...
    self.spaces=spaces
    self.border=border
    border_chr_num= 1+spaces+len(word)+spaces+1
    print(word,'Button Specifications:')
    print('Button name:',word)
    print('Number of the border characters for the top and the bottom:',border_chr_num)
...
class box:
  def __init__(self,dm):
    ...
    print('Volume of the box is ',dm[0]*dm[1]*dm[2],' cubic unit')
